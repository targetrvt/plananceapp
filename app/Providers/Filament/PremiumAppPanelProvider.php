...
use App\Http\Middleware\EnsurePremiumSubscriber;
...
class PremiumAppPanelProvider extends PanelProvider
{
    public function boot(): void
    {
        ...
        FilamentView::registerRenderHook(
            ...
            fn (): View => view('filament.components.premium-panel-enter-overlay'),
        );
    }
