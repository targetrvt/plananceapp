...
use App\Http\Middleware\AuthenticatePulseViewer;
...
return [
    ...
    */
    ...
    'recorders' => [
        ...
        App\Pulse\Recorders\IncomingTrafficRecorder::class => [
            'enabled' => env('PULSE_TRAFFIC_AGGREGATES_ENABLED', true),
            'sample_rate' => env('PULSE_TRAFFIC_AGGREGATES_SAMPLE_RATE', 1),
            'ignore' => [
